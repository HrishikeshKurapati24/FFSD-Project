...
const AdminUserManagementService = require("../services/admin/adminUserManagementService");
...
const UserManagementController = {
    async getUserManagementPage(req, res) {
        try {
            ...
            let influencers = await AdminUserManagementService.getInfluencers();
            let brands = await AdminUserManagementService.getBrands();
            ...
            const suspiciousActivityIds = await AdminDashboardService.prototype.checkSuspiciousActivity(); // checkSuspiciousActivity is an instance method in the class definition, but defined in object literal... wait, let's check definition. 
            ...
            // Easier to instantiate: new AdminDashboardService().checkSuspiciousActivity()

            let suspiciousUsers = [];
            try {
                const activity = await new AdminDashboardService().checkSuspiciousActivity();
    ...
    async approveUser(req, res) {
        try {
            ...
            const result = await AdminUserManagementService.approveUser(id, userType);
    ...
    async getBrandDetails(req, res) {
        try {
            ...
            const brand = await AdminUserManagementService.getBrandById(id);
            if (!brand) {
    ...
    async getInfluencerDetails(req, res) {
        try {
            ...
            const influencer = await AdminUserManagementService.getInfluencerById(id);
            if (!influencer) {
